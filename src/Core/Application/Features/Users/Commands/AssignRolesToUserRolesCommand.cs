...
{
    public class AssignUserRolesCommand : IRequest<IResponse>
    {
        public int UserId { get; set; }
        public List<int> RoleIds { get; set; }

        public class AssignUserRolesCommandHandler : IRequestHandler<AssignUserRolesCommand, IResponse>
        {
            ...
            public async Task<IResponse> Handle(AssignUserRolesCommand request, CancellationToken cancellationToken)
            {
